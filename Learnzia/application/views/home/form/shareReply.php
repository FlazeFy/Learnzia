<?php
	foreach($dataReply as $data){	
		echo"
		<div class='modal fade' id='shareRep".$data['id_reply']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
			<div class='modal-dialog' role='document'>
				<form action='homeCtrl/shareRep' method='post'>
					<input name='id_reply' value='".$data['id_reply']."' hidden>
