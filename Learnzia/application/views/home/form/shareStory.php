<?php
	foreach($allStory as $sty){	
		echo"
		<div class='modal fade' id='shareStory".$sty['id_story']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
			<div class='modal-dialog' role='document'>
				<form action='homeCtrl/shareStory' method='post'>
					<input name='id_story' value='".$sty['id_story']."' hidden>
