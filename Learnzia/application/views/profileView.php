...
<html>
    ...
    <body>
											...
											if($invitation['type'] != 'friend'){
												...
												<div class='card' style='border: none; background-color:#3b3b3b; margin:1%; border-radius:5px;'>
													<div class='card-header' style=''>
														<h5 style='font-size:17px; color:whitesmoke;'>".$invitation['sender']." invite you to join a class</h5>
		...
		<div class='modal-dialog' role='document' style='overflow-y: initial;'>
			...
			<div class='modal-content' style='background-color:#313436;' enctype='multipart/form-data'>
			<div class='modal-header'>
				<div class='container'>
		...
		<div class='modal-dialog' role='document' style='overflow-y: initial;'>
			<form method='POST' action='profileCtrl/sendRMessage' enctype='multipart/form-data'>
			<div class='modal-content' style='background-color:#313436;'>
			<div class='modal-header'>
				<div class='container'>
