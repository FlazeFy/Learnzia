<div class="container" style="margin-top:10rem;">
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="card bg-transparent">
				<img src="http://localhost/Learnzia/assets/images/storyset/Stories.png" width="250" class="img-fluid">
		...
		<div class="col-lg-4 mt-4 mt-lg-0">
			<div class="card bg-transparent">
				<img src="http://localhost/Learnzia/assets/images/storyset/Article.png" width="250" class="img-fluid">
		...
		<div class="col-lg-4 mt-4 mt-lg-0" >
			<div class="card bg-transparent">
				<img src="http://localhost/Learnzia/assets/images/storyset/Quiz.png" width="250" class="img-fluid">
